...
use crate::dharithri_sc::api::ManagedTypeApi;
...
impl<M: ManagedTypeApi> From<crate::dharithri_sc::types::BigUint<M>> for BigUintValue {
    fn from(from: crate::dharithri_sc::types::BigUint<M>) -> Self {
