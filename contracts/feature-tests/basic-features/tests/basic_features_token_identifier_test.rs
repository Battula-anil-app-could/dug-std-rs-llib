use dharithri_sc::types::{EgldOrEsdtTokenIdentifier, ManagedBuffer, TokenIdentifier};
...
/// For a complete suite of test cases, see `dharithri-sc-scenario/tests/managed_token_identifier_test.rs`.
#[test]
