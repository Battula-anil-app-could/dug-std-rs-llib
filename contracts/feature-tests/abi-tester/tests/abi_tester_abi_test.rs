...
use dharithri_sc_meta::abi_json;
use dharithri_sc_scenario::ScenarioWorld;
...
fn abi_tester_abi_generated_ok() {
    ...
    // generate ABI
    let multi_contract_config = dharithri_sc_meta::multi_contract_config::<abi_tester::AbiProvider>(
        blockchain
            .current_dir()
